<template>
  <div>
    <v-app-bar clipped-left>
      ...
      <div class="flex">
        <router-link to="/products" class="navbar"><v-btn icon><v-icon>mdi-shopify</v-icon></v-btn></router-link>
        <div v-if="!getStateLogin">
          <router-link to="/users/login" class="navbar">Login</router-link>
          <router-link to="/users/register" class="navbar">Register</router-link>
        </div>
        <div v-else>
          <router-link to="/profiles" class="navbar"><v-btn icon><v-icon>mdi-account-circle</v-icon></v-btn></router-link>
